...
function CategoryImagesCard({ item, btnTitle, type, title }: CategoryImagesCardProps) {
    ...
    return (
        <Grid className={classes.btnDiv}>
            ...
            <Link
                ...
                to={title === item.category_title ? `/dresses/category=${item.category_id}/collectionType=${type}` : `/dresses/category=${item.category_id}/collectionType=summer`}
            >
                <button
                    style={{
