        ...
        <div className={classes.news__item}>
          ...
          <div className={classes.news__text}>
            ...
            <p className={classes.news__p}>
              Стать успешным можно в любом возрасте. Главное — найти дело,
              которое нравится. Только в этом случае работа будет приносить
              счастье. И деньги. В качестве подтверждения этих слов расскажем
              одну совершенно необычную истории успеха, в которой
              предприниматель моложе 20 лет превратил свои личные интересы в
              прибыльный бизнес.
            </p>
          </div>
        </div>
